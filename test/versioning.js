...
const testFunc    = require('../lib/rules/versioning');
...
describe('versioning', function() {
  ...
  it('should set an error if the header contains versioning', function(done) {
  ...
  it('should not set any rules if the required header is present and not versioned', function(done) {
    ...
    testFunc(payload, function(err) {
      ...
      if(rules.length > 0)
        assert.fail('No rules should be set when the header is set without versioning');
